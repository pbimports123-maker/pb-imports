    ...
    <div className="wrapper">
      ...
      {showBanner && updatesCount > 0 && (
        <div className="notif-banner">
          ...
          <div className="notif-text">
            <strong>
              {updatesCount}{" "}
              {updatesCount === 1 ? "atualizaÃ§Ã£o" : "atualizaÃ§Ãµes"} desde
              sua Ãºltima visita
            </strong>
            <span>
              {updatesCount === 1
      ...
      >
        ...
        <div className="quick-banner-text">
          ...
          <span>Dicas e fatos rÃ¡pidos</span>
        </div>
      </Link>
      ...
      <div className="info-strip">
        ...
        <span>
          ...
          PB Imports. Produtos <span className="red">em falta</span> serÃ£o
          repostos em breve.
        </span>
      </div>

      <div className="results-count">
        Exibindo <span>{groups.length}</span> categorias Â·{" "}
      ...
      >
          ...
          {[
            {
              ...
              desc: "ConexÃ£o segura e criptografada",
            },
            {
              icon: "ðŸ’³",
              title: "Pagamento via Pix",
              desc: "AprovaÃ§Ã£o imediata e segura",
            },
            {
              icon: "ðŸ›¡ï¸",
              title: "Dados Protegidos",
              desc: "Sua privacidade Ã© prioridade",
            },
            {
              icon: "âœ…",
              title: "Compra Segura",
              desc: "SatisfaÃ§Ã£o garantida",
            },
          ].map((selo, i) => (
        ...
        <div className="footer-wrap">
          ...
          <p className="footer-copy">
            Â© {new Date().getFullYear()} PB Imports â€” Todos os direitos
            reservados.
          </p>
            ...
            <div className="cart-body">
              {cartItems.length === 0 ? (
                <div className="cart-empty">
                  ...
                  >
                    Adicione produtos do catÃ¡logo
                  </p>
                </div>
              ) : (
                cartItems.map((item) => (
